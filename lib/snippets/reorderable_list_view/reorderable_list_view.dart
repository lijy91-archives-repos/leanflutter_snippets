...
class SnippetReorderableListView extends StatefulWidget {
  const SnippetReorderableListView({Key key}) : super(key: key);
...
class _ListDemoState extends State<ReorderableListView> {
